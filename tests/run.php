...
$cases = array(
    ...
    __DIR__ . '/cases/dashboard-hide-panel-persistence.php',
    __DIR__ . '/cases/dashboard-panel-recent-empty.php',
    __DIR__ . '/cases/dashboard-panel-recent-minute-abbreviation.php',
    __DIR__ . '/cases/dashboard-panel-recent-trash-filter.php',
    __DIR__ . '/cases/settings-sanitize-programmatic-update.php',
