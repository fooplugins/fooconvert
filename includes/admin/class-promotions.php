    ...
    <div class="fooconvert-slider">
        ...
        public function render_metrics( $widget_id, $widget ) {
            ...
            <div class="pro-info-panel">
                ...
                <p><?php esc_html_e('These advanced metrics are available in the PRO Analytics Addon.', 'fooconvert'); ?> <a href="<?php echo esc_url( fooconvert_admin_url_addons() ); ?>"><?php esc_html_e('Buy PRO Analytics!', 'fooconvert'); ?></a></p>
            </div>
<?php
        }
